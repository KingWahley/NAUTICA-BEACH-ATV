...
export default function MarqueeSection() {
  return (
    <section className="bg-brand-black  outline-2 outline-brand-black w-[110vw] -ml-[5vw] -skew-y-2 py-8 my-16 overflow-hidden relative z-10 selection:bg-brand-orange selection:text-brand-black">
